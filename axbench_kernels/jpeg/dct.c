...
__attribute__((always_inline)) void levelShift (APPROX INT16* const data)
{
    INT16 i;
...
__attribute__((always_inline)) void dct (APPROX INT16 *data)
{
...
/*  All values are shifted left by 10
    ...
    APPROX static const UINT16 c1=1420;    /* cos PI/16 * root(2)  */
    APPROX static const UINT16 c2=1338;    /* cos PI/8 * root(2)   */
    APPROX static const UINT16 c3=1204;    /* cos 3PI/16 * root(2) */
    APPROX static const UINT16 c5=805;     /* cos 5PI/16 * root(2) */
    APPROX static const UINT16 c6=554;     /* cos 3PI/8 * root(2)  */
    APPROX static const UINT16 c7=283;     /* cos 7PI/16 * root(2) */

    APPROX static const UINT16 s1=3;
    APPROX static const UINT16 s2=10;
    APPROX static const UINT16 s3=13;
